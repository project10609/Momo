...
class MomoeyeshadowSpider(scrapy.Spider):
    name = 'momoeyeshadow'
    start_urls = [
        'https://www.momomall.com.tw/s/category/1801400011/%E7%9C%BC%E5%BD%B1/']
    ...
    def parse(self, response):
        ...
        next_page = 'https://www.momomall.com.tw/s/category/1801400011/4/' + \
            str(MomoeyeshadowSpider.page) + '/%E7%9C%BC%E5%BD%B1/'
        if MomoeyeshadowSpider.page <= 100:

            MomoeyeshadowSpider.page += 1
            url = next_page
