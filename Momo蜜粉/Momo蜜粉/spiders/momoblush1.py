...
class Momoblush1Spider(scrapy.Spider):
    name = 'momoblush1'
    start_urls = [
        'https://www.momomall.com.tw/s/category/1801400005/%E8%9C%9C%E7%B2%89/']
    ...
    def parse(self, response):
        ...
        next_page = 'https://www.momomall.com.tw/s/category/1801400017/4/' + \
            str(Momoblush1Spider.page) + '/%E8%9C%9C%E7%B2%89/'
        if Momoblush1Spider.page <= 100:

            Momoblush1Spider.page += 1
            url = next_page
